                ...
                <tr>
                  ...
                  <td>
                    <p style="margin-bottom: 10px;">
                      <a href="mem_edit.php?mem_id=<?php echo $row_member['mem_id'] ?>"
                  ...
                  <td><a href="member_db.php?mem_id=<?php echo $row_member['mem_id'] ?> && member=del" class="del-btn btn btn-danger" onclick="return confirm('ต้องการลบข้อมูลนี้ใช่หรือไม่')">
