...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 13, 2025 at 03:53 PM
...
(0016, 1, 'ลูกค้าหน้าร้าน', 4, 'ชำระหน้าร้าน', 140.00, 200.00, '2025-01-13 21:51:26');
...
--
ALTER TABLE `tbl_order`
  MODIFY `order_id` int(4) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `tbl_order_detail`
--
ALTER TABLE `tbl_order_detail`
  MODIFY `d_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
